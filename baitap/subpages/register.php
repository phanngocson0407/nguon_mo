	...
	<div class="panel panel-primary">
	    <div class="panel-body">
            ...
            <div class="form-group">
				...
				<input type="password" class="form-control" name="passlg" placeholder="Nhập lại mật khẩu..." required>
			</div>

            <div class="form-group">
				<label for="pwd">Email:</label>
				<input type="email" class="form-control" name="passlg" placeholder="Nhập email" required>
			</div>

			<button type="submit" class="btn btn-default" name="dangnhap">'Đăng ký'</button>
	    </div>
	</div>
</div>
</form>
